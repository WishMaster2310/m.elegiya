...
gulp.task('less:dev', function() {
  ...
  return gulp.src('public/__less/style.less')
...
gulp.task('default', function() {
  ...
  gulp.watch(['views/**/*.html', 'views/*.html', './datasource/base.json', './app.js'], function(event) {
    server.notify(event);
  ...
  gulp.watch(['public/__less/*.less', 'public/__less/**/*.less'], ['less:dev', server.notify]);
});
